...
void DIO_voidSetPinDir(u8 copy_u8port, u8 copy_u8pin  , u8 copy_u8dir) {
	...
	else if (copy_u8dir == INPUT)
	{
		...
		switch(copy_u8port) {
			...
			case DIO_PORTA :    CLEAR_BIT(DDRA_REG,copy_u8pin);break;
			case DIO_PORTB :    CLEAR_BIT(DDRB_REG,copy_u8pin);break;
			case DIO_PORTC :    CLEAR_BIT(DDRC_REG,copy_u8pin);break;
			case DIO_PORTD :    CLEAR_BIT(DDRD_REG,copy_u8pin);break;
		}
	}
...
void DIO_voidSetPinVal(u8 copy_u8port, u8 copy_u8pin  , u8 copy_u8val) {
	...
	else if (copy_u8val == LOW)
	{
		switch(copy_u8port) {
			...
			case DIO_PORTA :    CLEAR_BIT(PORTA_REG,copy_u8pin);break;
			case DIO_PORTB :    CLEAR_BIT(PORTB_REG,copy_u8pin);break;
			case DIO_PORTC :    CLEAR_BIT(PORTC_REG,copy_u8pin);break;
			case DIO_PORTD :    CLEAR_BIT(PORTD_REG,copy_u8pin);break;
		}
	}
